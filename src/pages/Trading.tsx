    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">Alpaca Paper Trading Account Performance</p>
        </div>

        {/* Account Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            <h3 className="text-slate-400 text-sm mb-2">Portfolio Value</h3>
            <p className="text-3xl font-bold text-white">{account && formatCurrency(account.equity)}</p>
          </div>
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            <h3 className="text-slate-400 text-sm mb-2">Cash</h3>
            <p className="text-3xl font-bold text-white">{account && formatCurrency(account.cash)}</p>
          </div>
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            <h3 className="text-slate-400 text-sm mb-2">Return %</h3>
            <p className={`text-3xl font-bold ${totalReturnPct >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700 mb-8">
          ...
          {portfolioHistory && portfolioHistory.equity && portfolioHistory.equity.length > 0 ? (
            <>
              <div 
                className="relative h-64 bg-slate-900/50 rounded-lg p-4"
                onMouseLeave={() => {
