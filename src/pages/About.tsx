            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-slate-300 text-lg leading-relaxed mb-4">
                  I'm a Data Science enthusiast and junior in college working towards a degrees in Applied Mathematics and Computer Science from the University of Delaware's Honors College. Currently, I'm passionate about building machine learning solutions that drive real business value, from predictive analytics to quantitative finance models and sports analytics.
                </p>
                <p className="text-slate-300 text-lg leading-relaxed">
                  My experience spans data pipeline development, feature engineering, and deploying ML models. I combine strong mathematical foundations with practical software engineering to solve complex data-driven problems. I'm particularly interested in financial analytics and sports data science.
                </p>
              </div>
